            ...
            <div class="navigation-wrap">
                <ul class="navigation list-inline list-unstyled">
                    ...
                    <li id="menu-item-1600"
                        ...
                        <ul role="menu" class=" dropdown-menu">
                            ...
                            <li id="menu-item-1747"
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    ...
                                    <li id="menu-item-1944"
                                        ...
                                        <a title="Granjas" href="/categoria-del-anuncio/alquiler-de-granjas">Granjas</a>
                                    </li>
                            ...
                            <li id="menu-item-1750"
                                ...
                                <a title="Ropa" href="/categoria-del-anuncio/alquiler-de-ropa/" data-toggle="dropdown"
                                    class="dropdown-toggle" data-hover="dropdown" aria-haspopup="true">Ropa <i
                            ...
                            <li id="menu-item-1751"
                                ...
                                <a title="Maquinaria" href="/categoria-del-anuncio/maquinaria/" data-toggle="dropdown"
                                    class="dropdown-toggle" data-hover="dropdown" aria-haspopup="true">Maquinaria <i
                                        class="fas fa-angle-right"></i>
                                    <ul role="menu" class=" dropdown-menu">
                            ...
                            <li id="menu-item-1792"
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li id="menu-item-1788"
                                        ...
                                        <a title="Mobiliario" href="/categoria-del-anuncio/mobiliario/">Mobiliario</a>
                                    </li>
                                    ...
                                    <li id="menu-item-1955"
                                        ...
                                        <a title="Carpas" href="/categoria-del-anuncio/alquiler-de-Carpas">Carpas</a>
                                    </li>
                                    ...
                                    <li id="menu-item-1956"
                                        ...
                                        <a title="Sillas" href="/categoria-del-anuncio/alquiler-de-sillas">Sillas</a>
                                    </li>
                            ...
                            <li id="menu-item-1943"
                                ...
                                <a title="Otros" href="/categoria-del-anuncio/alquiler-de-otros" data-toggle="dropdown"
                                    class="dropdown-toggle" data-hover="dropdown" aria-haspopup="true">Otros <i
                                        class="fas fa-angle-right"></i>
                                    <ul role="menu" class=" dropdown-menu">
                    ...
                    <li id="menu-item-2169"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2169"><a title="Ayuda"
                            href="#">Ayuda</a></li>
                    <li id="menu-item-1597"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1597"><a
                            title="Contacto" href="#">Contacto</a></li>
                </ul>
            </div>
